...
public class AdminOperation implements AdminDAOInterFace {
	...
	public boolean adminLogin(String adminuserName, String adminPassword) throws UserNotFoundException {
		...
		try {
			PreparedStatement preparedStatement = connection
					.prepareStatement(SQLQueriesConstants.ADMIN_VERIFY_CREDENTIALS);
	...
	public List Professors() throws SQLException {
		...
		ResultSet rs = stmt.executeQuery();
		while (rs.next()) {
			professorList.add(new Professor(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4),
	...
	public void approveProfessor(int professorId, String approved) throws UserNotFoundException {
		// TODO Auto-generated method stub
		try {
			PreparedStatement stmt = connection.prepareStatement(SQLQueriesConstants.ADMIN_APPROVE_PROFESSOR);
